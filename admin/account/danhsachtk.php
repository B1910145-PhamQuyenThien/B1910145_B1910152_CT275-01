            ...
            <div class="col-10 bg-light">
                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-2">
                                <a href="index_admin.php?page_layout=themtk" class="btn btn-primary">+ THÊM TÀI
                                    KHOẢN</a>
                            </div>
                        ...
                        while($row = $result -> fetch()){?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="index_admin.php?page_layout=suatk&id=<?php echo $row['id_kh']; ?>"
                                                class="btn btn-primary">Sửa</a>
                                            <a onclick="return Del('<?php echo $row['fullName']?>')"
                                                href="index_admin.php?page_layout=xoatk&id=<?php echo $row['id_kh']; ?>"
